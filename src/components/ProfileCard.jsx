...
return (
    <div className="card flex flex-col transform font-serif transition duration-300 hover:scale-105 hover:z-10 hover:shadow-2xl items-center w-full sm:w-1/2 lg:w-1/3 mb-10 p-4 rounded-xl bg-gray-300 text-center shadow-lg">
        <img
